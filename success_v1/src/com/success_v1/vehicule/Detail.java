...
public class Detail extends Activity {
 ...
 // JSON Node names
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        couleur_vehicule = (TextView) findViewById(R.id.couleurVehicule);
        moteur_vehicule = (TextView) findViewById(R.id.motorVehicule);
        annee_vehicule = (TextView) findViewById(R.id.anneeVehicule);
        km_vehicule = (TextView) findViewById(R.id.kmVehicule);
    ...
    class GetCarDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            try {           		            
	            ...
	            couleur_vehicule.setText(detail_tab.getString(TAG_COLOR));
	            km_vehicule.setText(detail_tab.getString(TAG_KM));
	            annee_vehicule.setText(detail_tab.getString(TAG_YEAR));
